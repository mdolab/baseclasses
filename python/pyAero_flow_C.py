...
class Flow(object):
    ...
    def __str__(self):
        ...
        return ('name    mach    alpha    beta    phat    rhat    qhat\n'+'     '+str(self.name).center(9) +'(%8.2f,%8.2e) %8.2f %8.2f %8.2f %8.2f %8.2f\n' %(real(self.mach),imag(self.mach), real(self.alpha), real(self.beta), self.phat, self.rhat, self.qhat))
